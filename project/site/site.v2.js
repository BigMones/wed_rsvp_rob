...
const STOPS = [
  { id:1,  name:"Sydney",            country:{it:"Australia",  en:"Australia"},      x:88, y:80, lng:151.21, lat:-33.87,
  ...
  { id:2,  name:"Tasmania",          country:{it:"Australia",  en:"Australia"},      x:83, y:92, lng:147.33, lat:-42.88,
  ...
  { id:3,  name:"Indonesia",         country:{it:"Indonesia",  en:"Indonesia"},      x:78, y:62, lng:115.09, lat:-8.34,
  ...
  { id:4,  name:"Filippine",         country:{it:"Filippine",  en:"Philippines"},    x:82, y:48, lng:119.41, lat:11.20,
  ...
  { id:5,  name:"U.S.A.",            country:{it:"Stati Uniti",en:"United States"},   x:14, y:42, lng:-115.14, lat:36.17,
  ...
  { id:6,  name:"Monaco di Baviera", country:{it:"Germania",   en:"Germany"},        x:53, y:26, lng:11.58, lat:48.14,
  ...
  { id:7,  name:"Parigi",            country:{it:"Francia",    en:"France"},         x:47, y:30, lng:2.35, lat:48.86,
  ...
  { id:8,  name:"Canarie",           country:{it:"Spagna",     en:"Spain"},          x:38, y:48, lng:-16.63, lat:28.29,
  ...
  { id:9,  name:"Edimburgo",         country:{it:"Scozia",     en:"Scotland"},       x:46, y:17, lng:-3.19, lat:55.95,
  ...
  { id:10, name:"Londra",            country:{it:"Inghilterra",en:"England"},        x:45, y:24, lng:-0.13, lat:51.51,
  ...
  { id:11, name:"Napoli",            country:{it:"Italia",     en:"Italy"},          x:54, y:39, lng:14.27, lat:40.85, final:true,
...
function buildMap(){
  // The world map / globe rendering is handled by atlas-geo.js (real geography).
  if(window.AtlasGeo){
    window.AtlasGeo.init({ stops:STOPS, onSelect:setActive, getLang:()=>LANG });
  }
}
...
function renderJourney(){
  ...
  // map / globe visual (handled by atlas-geo.js)
  if(window.AtlasGeo) window.AtlasGeo.setActive(ACTIVE);
  // panel
