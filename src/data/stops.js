export const STOPS = [
  {
    id: 1, name: { it: 'Sydney', en: 'Sydney' }, country: { it: 'Australia', en: 'Australia' },
  ...
  {
    id: 2, name: { it: 'Tasmania', en: 'Tasmania' }, country: { it: 'Australia', en: 'Australia' },
  ...
  {
    id: 3, name: { it: 'Bali', en: 'Bali' }, country: { it: 'Indonesia', en: 'Indonesia' },
    lng: 115.09, lat: -8.34,
  ...
  {
    id: 4, name: { it: 'Palawan', en: 'Palawan' }, country: { it: 'Filippine', en: 'Philippines' },
  ...
  {
    id: 5, name: { it: 'U.S.A.', en: 'U.S.A.' }, country: { it: 'Stati Uniti', en: 'United States' },
  ...
  {
    id: 6, name: {it:'Monaco di Baviera',en:'Munich'}, country: { it: 'Germania', en: 'Germany' },
    lng: 11.58, lat: 48.14,
  ...
  {
    id: 7, name: {it:'Parigi',en:'Paris'}, country: { it: 'Francia', en: 'France' },
    lng: 2.35, lat: 48.86,
  ...
  {
    id: 8, name: {it:'Canarie',en:'Canaries'}, country: { it: 'Spagna', en: 'Spain' },
    lng: -16.63, lat: 28.29,
  ...
  {
    id: 9, name:{it: 'Edimburgo',en:'Edinburgh'}, country: { it: 'Scozia', en: 'Scotland' },
    lng: -3.19, lat: 55.95,
  ...
  {
    id: 10, name: {it:'Londra',en:'London'}, country: { it: 'Inghilterra', en: 'England' },
    lng: -0.13, lat: 51.51,
