...
export default function Hero() {
  ...
  return (
    <header className="hero">
      ...
      <div className="kicker pre hero-sub">A Roos Wedding</div>
      ...
      <p className="tag">
        {t("Ogni storia d'amore è un viaggio. Benvenuti a bordo del nostro.", "Every love story is a journey. Welcome aboard ours.")}
      </p>
      <div className="meta">
        <div className="col">
